...
def generate_password(
    length=12, use_symbols=True, use_numbers=True, use_uppercase=True
):
...
def main():
    ...
    parser.add_argument(
        "-l", "--length", type=int, default=12, help="Longueur du mot de passe"
    )
    parser.add_argument(
        "-n", "--count", type=int, default=1, help="Nombre de mots de passe"
    )
    ...
    parser.add_argument(
        "-p", "--passphrase", action="store_true", help="Générer une phrase de passe"
    )
